    ...
    return (
      <div className="RandomNumberPicker__choice px-2">
        <div className="numberWrapper">
            <img id="randomTemplate" className="img-fluid" src="../img/firstnumber.png" alt="template"></img>
            <span id="choiceNumber" className="RandomPicker__choiceItem">{result1}</span>
        </div>
        <div className="numberWrapper">
            <img id="randomTemplate" className="img-fluid" src="../img/random_num_temp.png" alt="template"></img>
        ...
        <div className="numberWrapper">
            <img id="randomTemplate" className="img-fluid" src="../img/fourthnumber.png" alt="template"></img>
